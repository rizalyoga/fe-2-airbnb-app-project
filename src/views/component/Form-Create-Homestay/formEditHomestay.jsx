...
const FormEditHomestay = () => {
  ...
  //UseEffectAddHomestay
  useEffect(() => {
    console.log("Ini detail User UseEffect Form:", detailHomestay);
    setNama(detailHomestay.Nama);
    setAlamat(detailHomestay.Alamat);
  ...
  const handleSubmit = (event) => {
    ...
    dispatch(allStore.EditHomestay(data, id));
  };
  ...
  return (
    <div>
      <NavbarPage />
      <h1 className="text-center my-5">FORM EDIT HOMESTAY</h1>
...
export default FormEditHomestay;
